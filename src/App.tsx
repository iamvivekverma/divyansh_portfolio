        ...
        <div className="relative -mt-2 overflow-hidden bg-[var(--color-ink)] text-[var(--color-paper)] pb-12">
          ...
          <div className="relative z-10 mx-auto flex max-w-[1320px] flex-col gap-8 px-5 py-10 sm:px-8 sm:py-12 md:px-12 md:py-14 lg:flex-row lg:items-end lg:justify-between lg:px-16 lg:py-16 xl:px-24 xl:py-20">
            ...
            <Reveal className="flex w-full flex-col gap-2 sm:w-auto sm:min-w-[280px]" y={20} delay={120} duration={750}>
              <a
                href="https://wa.me/917258889848?text=Hi%20Divyansh%2C%20I%27m%20interested%20in%20booking%20a%20free%20trial%20session%20for%20chess%20coaching."
                target="_blank"
          ...
          <div className="mx-auto max-w-[1240px]">
            ...
            <div className="grid gap-8 md:grid-cols-2 md:gap-12">
              <Reveal className="md:block" delay={80}>
                <div>
                  <p className="text-[0.92rem] leading-[1.75] text-[var(--color-ink-soft)] sm:text-[0.98rem]">
                    I'm <strong>Divyansh Singh</strong> — a{" "}
                    <strong>State and National-level chess player</strong>. As a{" "}
                    <strong>3-time State Championship winner</strong> and{" "}
                    <strong>National 1st Runner-up</strong> in team events, my coaching is
                    grounded in <strong>real, tournament-tested experience</strong> rather
                    than pure theory. I've also secured multiple District Champion and
                    Runner-up titles throughout my competitive journey.
                  </p>

                  <p className="mt-5 text-[0.92rem] leading-[1.75] text-[var(--color-ink-soft)] sm:text-[0.98rem]">
                    <strong>
                      I've trained 500+ students across 20+ countries, guiding players to
                      earn official FIDE and USCF ratings.
                    </strong>
                  </p>
                </div>
              </Reveal>
              ...
              <Reveal className="md:block" delay={160}>
                <div>
                  <p className="text-[0.92rem] leading-[1.75] text-[var(--color-ink-soft)] sm:text-[0.98rem]">
                    Instead of throwing endless engine variations at the board, we slow the
                    position down. We learn what to notice first, what to calculate next,
                    and which decisions actually deserve your attention.
                  </p>

                  <p className="mt-5 text-[0.92rem] leading-[1.75] text-[var(--color-ink-soft)] sm:text-[0.98rem]">
                    With <strong>3+ years of coaching experience</strong>, I focus on
                    developing <strong>calculation, tactical awareness, positional understanding,
                      opening preparation, game analysis, and practical decision-making</strong>.
                    I believe in adapting my teaching approach to each student's level,
                    goals, and playing style while helping them become more confident and
                    independent players.
                  </p>
                </div>
              </Reveal>
          ...
          <div className="mx-auto max-w-[1240px]">
            ...
            <div className="grid gap-4 sm:gap-5 lg:grid-cols-4">
              ...
              <Reveal className="lg:col-span-2" y={28}>
                <a
                  href="https://wa.me/917258889848?text=Hi%20Divyansh%2C%20I%27m%20interested%20in%20private%20coaching%20sessions."
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block"
                >
              ...
              <Reveal className="lg:col-span-2" y={28} delay={80}>
                <a
                  href="https://wa.me/917258889848?text=Hi%20Divyansh%2C%20I%27m%20interested%20in%20group%20coaching%20sessions."
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block"
                >
              ...
              <Reveal className="lg:col-span-2" y={28} delay={120}>
                <a
                  href="https://wa.me/917258889848?text=Hi%20Divyansh%2C%20I%27m%20interested%20in%20coaching%20from%20beginner%20to%20advanced%20level."
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block"
                >
              ...
              <Reveal className="lg:col-span-2" y={28} delay={160}>
                <a
                  href="https://wa.me/917258889848?text=Hi%20Divyansh%2C%20I%27m%20interested%20in%20competitive%20training%20for%20tournaments."
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block"
                >
